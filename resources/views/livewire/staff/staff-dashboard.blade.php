            ...
            <div class="col-12 col-sm-6 col-md-3">
                <div class="stat-card">
                    ...
                    <div class="stat-info mt-1">
                        ...
                        <div class="d-flex justify-content-between mt-1">
                            <small class="text-muted small">Today Sales</small>
                            <small class="fw-bold text-jg-blue">Rs.{{ number_format($todaySalesAmount, 2) }}</small>
                        </div>
                    </div>
        ...
        <div class="row g-2 g-md-3 mb-3 mb-md-4">
            <div class="col-12 col-sm-6 col-md-3">
                <div class="stat-card">
                    ...
                    <div class="stat-value">{{ number_format($totalSalesCount) }}</div>
                    <div class="stat-info mt-2 pt-2 border-top">
                        <small class="text-muted">All transactions created by you</small>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-3">
                <div class="stat-card">
                    ...
                    <div class="stat-info mt-2 pt-2 border-top">
                        <small class="text-muted">Rs.{{ number_format($todaySalesAmount, 2) }}</small>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-3">
                <div class="stat-card">
                    ...
                    <div class="stat-value text-warning">{{ number_format($pendingSalesCount) }}</div>
                    <div class="stat-info mt-2 pt-2 border-top">
            ...
            <div class="col-12 col-sm-6 col-md-3">
                <div class="stat-card">
                    ...
                    <div class="stat-value text-success">{{ number_format($confirmedSalesCount) }}</div>
                    <div class="stat-info mt-2 pt-2 border-top">
                        <small class="text-muted">Approved transactions</small>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body p-3 p-md-4">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h6 class="mb-0 fw-bold">Recent Sales Report</h6>
                    <small class="text-muted">Latest 15 transactions</small>
                </div>
                        ...
                        <tbody>
                            @forelse($salesReport as $sale)
                                <tr>
                                    ...
                                    <td>{{ \Illuminate\Support\Carbon::parse($sale->created_at)->format('M d, Y') }}</td>
                                </tr>
                            @empty
                                <tr>
