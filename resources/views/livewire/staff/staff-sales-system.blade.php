                    ...
                    <div class="sale-preview p-4" id="saleReceiptPrintContent">
                        ...
                        <div class="invoice-footer mt-4">
                            ...
                            <div class="border-top pt-3" style="font-size: 0.7rem; line-height: 1.2;">
                                <p class="text-center mb-1" style="margin-bottom: 0.3rem;"><strong>ADDRESS :</strong> No-10 Keyzer Street, Colombo 11.</p>
                                <p class="text-center mb-1" style="margin-bottom: 0.3rem;"><strong>TEL :</strong> 0777005897 / 0112337242, <strong>EMAIL :</strong> gizmoelectronicsofficial@gmail.com</p>
