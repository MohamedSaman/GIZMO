<div class="container-fluid py-3">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Manage customer dues and receive payments (All Staff)</p>
        </div>
    </div>
            ...
            <div class="row g-3">
                <div class="col-md-5">
                    <div class="input-group">
                        ...
                        <input type="text" wire:model.live.debounce.300ms="search" class="form-control" placeholder="Search by invoice, customer, or staff name...">
                    </div>
                </div>
                <div class="col-md-3">
