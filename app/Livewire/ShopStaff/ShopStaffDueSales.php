...
class ShopStaffDueSales extends Component
{
    use WithPagination;
    ...
    public function render()
    {
        ...
        return view('livewire.shop-staff.shop-staff-due-sales', [
            'sales' => $query->with(['customer', 'payments'])->orderBy('created_at', 'desc')->paginate(15),
